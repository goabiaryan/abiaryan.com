...
tags:
  ...
  - deep learning
---
**10 May, 2019** 	:woman_zombie: `ORIGINALLY PUBLISHED ON OFFICIAL TENSORLAYER BLOG`
...
![abstraction gap](/ml-engineering/assets/why-tensorlayer/1.png)
...
![wrappers](/ml-engineering/assets/why-tensorlayer/2.png)

But do they compare?

![comparison](/ml-engineering/assets/why-tensorlayer/3.png)


## So what is TensorLayer?

![TensorLayer](/ml-engineering/assets/why-tensorlayer/4.png)
...
![high-level modules](/ml-engineering/assets/why-tensorlayer/5.png)

2 . It enables the users to build a model using native TensorFlow APIs

![Using TFlow API](/ml-engineering/assets/why-tensorlayer/6.png)

Also,

![Simplified Implementation](/ml-engineering/assets/why-tensorlayer/7.png)

3 . It enables the users to define their own computational operations

![Custom Operations](/ml-engineering/assets/why-tensorlayer/8.png)


4 . It enables the users to define their own training logic

![Custom Training Logic](/ml-engineering/assets/why-tensorlayer/9.png)
...
![Wrappers](/ml-engineering/assets/why-tensorlayer/10.png)

6 . It provides **zero-cost** abstraction (or negligible overhead)

![Quick Comparison](/ml-engineering/assets/why-tensorlayer/1.png)
