...
export const education = [
  ...
  },
  {
    ...
    note: "Thesis: Cascading Fragility in National AI Infrastructure:\nA Seven-Layer Framework for Resilience Assessment and Policy Design.\nMaster's thesis, NOVA IMS. (Preparing for Journal Submission.)",
  },
  {
    year: "2018-2019",
...
export const theses = [
  ...
  },
  {
    ...
    note: "MSc Applicable Mathematics, The London School of Economics and Political Science (LSE), 2013-2014.",
  },
  {
    year: "2013",
    title: "Are Twin Primes Infinite? (Literature Review)",
    note: "BSc (Honors) Mathematics, MDU. Distinction (Top 5). University record holder in Statistics.",
  },
];
